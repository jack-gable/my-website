	...
	return (
		<div className={styles.wrapper} id="about">
			...
			<div className={styles.container}>
				...
				<div className={styles.iconWrapper}>
					<div className={styles.icon} style={{ border: "2px solid #cc6699" }}>
						<FontAwesomeIcon icon={faSass} color="#cc6699" size="lg" />
						Sass
					</div>
					<div className={styles.icon} style={{ border: "2px solid #f0abee" }}>
						💅 Styled-Components
					</div>
					<div className={styles.icon} style={{ border: "2px solid #3c873a" }}>
						<FontAwesomeIcon icon={faNodeJs} color="#3c873a" size="lg" />
						Node.js
					</div>
					<div className={styles.icon} style={{ border: "2px solid #4b8bbe" }}>
						<FontAwesomeIcon icon={faPython} color="#4b8bbe" size="lg" />
						Python
					</div>
					<div className={styles.icon} style={{ border: "2px solid #a259ff" }}>
			...
			<div>
				...
				<p className={styles.desc}>
					...
					love learning new things especially cutting-edge technologies like
					Next.js. When I&apos;m not working on projects or learning new
